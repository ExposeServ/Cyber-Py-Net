...
def runsender(host, port, th, t):
    ...
    for _ in range(int(th)):
        try:
            thd = threading.Thread(target= sender, args=(host, port, until, rand))
            thd.start()
        except:
            pass
...
def help():
    ...
    stdout.write("             "+Fore.RED           +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"ovh      "+Fore.RED+"|"+Fore.LIGHTWHITE_EX+" Show Info On OVHS                      "+Fore.RED+"║\n")
    stdout.write("             "+Fore.RED           +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"credit   "+Fore.RED+"|"+Fore.LIGHTWHITE_EX+" Show Credit                            "+Fore.RED+"║\n")
    stdout.write("             "+Fore.RED           +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"home     "+Fore.RED+"|"+Fore.LIGHTWHITE_EX+" Home Page Cyber                        "+Fore.RED+"║\n")
    stdout.write("             "+Fore.RED           +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"exit     "+Fore.RED+"|"+Fore.LIGHTWHITE_EX+" Exit Cyber DDoS                        "+Fore.RED+"║\n")
    stdout.write("             "+Fore.RED           +"╠═════════════════════════════════════════════════════╣\n")
    stdout.write("             "+Fore.RED           +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"Discord  "+Fore.RED+"|"+Fore.LIGHTWHITE_EX+" gunszz                                 "+Fore.RED+"║\n")
    stdout.write("             "+Fore.RED           +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"Website  "+Fore.RED+"|"+Fore.LIGHTWHITE_EX+" www.gunservices.live                   "+Fore.RED+"║\n")
    stdout.write("             "+Fore.RED           +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"GunsOVHs "+Fore.RED+"|"+Fore.LIGHTWHITE_EX+" Get at my Discord for the best OVHs    "+Fore.RED+"║\n")
    stdout.write("             "+Fore.RED           +"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def credit():
    stdout.write(""+Fore.RED           +"═════════════════════════╗\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.RED   +"Developer "+Fore.RED+"| \x1b[38;2;255;20;147m>> "+Fore.LIGHTWHITE_EX+" gunszz\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.RED   +"UI Design "+Fore.RED+"| \x1b[38;2;255;20;147m>> "+Fore.LIGHTWHITE_EX+" gunszz\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.RED   +"Methods   "+Fore.RED+"| \x1b[38;2;255;20;147m>> "+Fore.LIGHTWHITE_EX+" gunszz\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.RED   +"Tester    "+Fore.RED+"| \x1b[38;2;255;20;147m>> "+Fore.LIGHTWHITE_EX+" gunszz\n")
    stdout.write(""+Fore.RED           +"═════════════════════════╝\n")
    stdout.write("\n")    
##############################################################################################
def ovh():
    stdout.write("  "+Fore.RED           +"╔═══════════════════════════════════════════════════════════════╗\n")
    stdout.write("  "+Fore.RED           +"║\x1b[38;2;255;20;147m• "+Fore.RED +"Go To www.gunsservices.sellpass.io"+Fore.RED+"                           ║\n")
    stdout.write("  "+Fore.RED           +"║ "+Fore.LIGHTWHITE_EX+" (UK) (FRANCE) (GERMANY) (USA) (CANADA) (SINGAPORE)"+Fore.RED+"           ║\n")
    stdout.write("  "+Fore.RED           +"║ "+Fore.LIGHTWHITE_EX+" If You Want To Purchase An OVH For A Month It Is £20"+Fore.RED+"         ║\n")
    stdout.write("  "+Fore.RED           +"║ "+Fore.LIGHTWHITE_EX+" Other Subscriptions Are 3 Months/1 Year"+Fore.RED+"                      ║\n")
    stdout.write("  "+Fore.RED           +"║ "+Fore.LIGHTWHITE_EX +" Need Further Info Discord "+Fore.RED+" >> Gunszz <<"+Fore.RED+"                      ║\n")
    stdout.write("  "+Fore.RED           +"║                                           "+Fore.RED+"                    ║\n")
    stdout.write("  "+Fore.RED           +"║\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"Reasons to go for my OVH Instead Of VPNs:"+Fore.RED+"                    ║\n")
    stdout.write("  "+Fore.RED           +"║ "+Fore.LIGHTWHITE_EX+" All VPNs Are Not Safe And Leak Your IP Online So I"+Fore.RED+"           ║\n")
    stdout.write("  "+Fore.RED           +"║ "+Fore.LIGHTWHITE_EX+" Would Suggest To Get A OVH So You're Safe From DDoS Attacks."+Fore.RED+" ║\n")
    stdout.write("  "+Fore.RED           +"║ "+Fore.LIGHTWHITE_EX+" All My OVHs Are Scripted By Gunszz Including The Best   "+Fore.RED+"     ║\n")
    stdout.write("  "+Fore.RED           +"║ "+Fore.LIGHTWHITE_EX+" Firewalls And IpTable You Have Ever Seen "+Fore.RED+"                    ║\n")
    stdout.write("  "+Fore.RED           +"║                                           "+Fore.RED+"                    ║\n")
    stdout.write("  "+Fore.RED           +"║"+Fore.MAGENTA+"• "+Fore.LIGHTWHITE_EX+"If You Paid For The Resellers One Go To Openvpn And Buy A"+Fore.RED+"    ║\n")
    stdout.write("  "+Fore.RED           +"║ "+Fore.LIGHTWHITE_EX+"  Subscription So You Can Pay To Have More People On Your OVH"+Fore.RED+" ║\n")
    stdout.write("  "+Fore.RED           +"╚═══════════════════════════════════════════════════════════════╝\n")
    stdout.write("\n") 
##############################################################################################
def layer7():
...
def layer4():
    ...
    stdout.write("             "+Fore.RED             +"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             "+Fore.RED             +"╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("             "+Fore.RED             +"║ \x1b[38;2;255;20;147m-> "+Fore.LIGHTGREEN_EX+"1000seconds "+Fore.RED +"|"+Fore.LIGHTWHITE_EX+" Max boot time                      "+Fore.RED +"║\n")
    stdout.write("             "+Fore.RED             +"║ \x1b[38;2;255;20;147m-> "+Fore.LIGHTGREEN_EX+"CTRL+Z "+Fore.RED +"|"+Fore.LIGHTWHITE_EX+" The attack when it is finished          "+Fore.RED +"║\n")
...
def title():
    ...
    stdout.write("             "+Fore.RED+"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             "+Fore.RED+"╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("             "+Fore.RED+"║ "+Fore.LIGHTWHITE_EX   +"       This Is The Main Screen Of Cyber          "+Fore.RED +"   ║\n")
    stdout.write("             "+Fore.RED+"║ "+Fore.LIGHTWHITE_EX   +"       Type [help] to see all the Commands       "+Fore.RED +"   ║\n")
    stdout.write("             "+Fore.RED+"║ "+Fore.LIGHTWHITE_EX   +"          Contact Dev - Discord "+Fore.RED +"[gunszz]         "+Fore.RED +"   ║\n")
    stdout.write("             "+Fore.RED+"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.RED+"╔═══"+Fore.RED+"[""Gunszz"+Fore.LIGHTGREEN_EX+"@"+Fore.RED+"Cyber"+Fore.RED+"]"+Fore.RED+"\n╚══\x1b"+Fore.RED+"> "+Fore.LIGHTWHITE_EX)
    command = input()
    if command == "home" or command == "clear":
        clear()
        title()
